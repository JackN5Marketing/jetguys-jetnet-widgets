...
.jng-market-summary{display:flex;flex-wrap:wrap;gap:14px;margin-bottom:16px}\
.jng-stat{min-width:120px;flex:1 1 120px;border:1px solid rgba(0,0,0,.15);border-top:3px solid #b59e27;border-radius:8px;padding:10px 12px;background:#fff}\
.jng-stat .v{font-size:21px;font-weight:700;color:#111}\
...
';
  ...
  function initWidget(root) {
    ...
    root.appendChild(el('h3', { html: 'Market Trends' }));
